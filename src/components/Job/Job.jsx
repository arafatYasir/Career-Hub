...
const Job = ({job}) => {
    const {job_role, company, company_logo, onsite_or_remote, location, employment_type, experience_level, salary, posted_date, application_deadline, benefits, expectation} = job;
    return (
