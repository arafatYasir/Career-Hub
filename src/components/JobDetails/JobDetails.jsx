        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row justify-between mt-[130px]">
                ...
                <div className="w-[340px]">
                    ...
                    <button className="w-full text-center py-[19px] text-white text-xl font-bold bg-linear-to-r from-[#7E90FE] to-[#9873FF] rounded-lg mt-6 cursor-pointer">Apply Now</button>
                </div>
            </div>
        </div>
    );
